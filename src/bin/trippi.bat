...
java -Xms64m -Xmx96m -Djava.endorsed.dirs="%TRIPPI_HOME%\lib" -Dtrippi.home="%TRIPPI_HOME%" -Dderby.system.home="%TRIPPI_HOME%\derby" org.trippi.ui.TrippiUI %1 %2 %3 %4 %5 %6 %7 %8 %9
goto end
:appNotFound
